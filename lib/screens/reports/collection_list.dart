...
class CollectionListScreenState extends State<CollectionListScreen> {
  ...
  Widget build(BuildContext context) {
    var appTitleBar = AppTitleBar(
        title: "Collection List", bgColor: ColorList.Colors.primaryColor);
    return WillPopScope(
      onWillPop: () async {
            ...
            SizedBox(
              ...
              child: RaisedButton(
                ...
                onPressed: () async {
                  ...
                  int deleted =
                      await LoanCollectionService.deleteLoanCollection(
                          idIn: deleteItems.join(","));
                  if (deleted > 0) {
                    setState(() {
                      showCheckBox = false;
                    });
  ...
  Future<void> loadList({int index}) async {
    var _list = await LoanCollectionService.getMemberWiseCollectionList(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    alignment: Alignment.center,
                    child: Text(loan.toStringAsFixed(0)),
                    padding: EdgeInsets.all(8.0),
                  ),
                  Container(
                    decoration: BoxDecoration(color: Colors.white),
